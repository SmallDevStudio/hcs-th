const productsTh = {
  ...
  quickStatus: "เปลี่ยนสถานะของ {{name}}",

  results: {
    summary: "พบสินค้าทั้งหมด {{total}} รายการ",
    range: "กำลังแสดง {{start}}-{{end}} จาก {{total}} รายการ",
  },
  ...
  bulk: {
    selected: "เลือกสินค้าแล้ว {{count}} รายการ",
    clearSelection: "ยกเลิกการเลือก",
    selectPage: "เลือกสินค้าทั้งหมดในหน้านี้",
    selectProduct: "เลือก {{name}}",

    actions: {
      publish: "เผยแพร่",
      unpublish: "ยกเลิกเผยแพร่",
      deactivate: "ตั้งเป็นไม่ใช้งาน",
      delete: "ย้ายไปถังขยะ",
    },

    confirm: {
      publish: {
        title: "เผยแพร่สินค้าที่เลือก?",
        text: "เผยแพร่สินค้า {{count}} รายการ สินค้าที่ข้อมูลไม่ครบจะไม่ถูกเปลี่ยนและแสดงในรายงานผล",
      },
      unpublish: {
        title: "ยกเลิกเผยแพร่สินค้าที่เลือก?",
        text: "เปลี่ยนสินค้า {{count}} รายการกลับเป็นฉบับร่าง",
      },
      deactivate: {
        title: "ปิดใช้งานสินค้าที่เลือก?",
        text: "เปลี่ยนสินค้า {{count}} รายการเป็นสถานะไม่ใช้งาน",
      },
      delete: {
        title: "ย้ายสินค้าที่เลือกไปถังขยะ?",
        text: "ย้ายสินค้า {{count}} รายการไปถังขยะ โดยสามารถกู้คืนได้ภายหลัง",
      },
    },
  },
  ...
  messages: {
    ...
    statusSuccess: "เปลี่ยนสถานะสินค้าเรียบร้อยแล้ว",

    statusFailed: "ไม่สามารถเปลี่ยนสถานะสินค้าได้",

    bulkSuccess: "จัดการสินค้า {{count}} รายการเรียบร้อยแล้ว",

    bulkPartial:
      "จัดการสำเร็จ {{success}} รายการ และไม่สำเร็จ {{failed}} รายการ",

    bulkFailed: "ไม่สามารถจัดการสินค้าที่เลือกได้",
